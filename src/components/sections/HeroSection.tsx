// src/components/sections/HeroSection.tsx - VERSIÓN RESPONSIVA CORREGIDA
  ...
  return (
    <div className="mb-4 flex justify-center feature-icon relative">
      <div className="p-3 rounded-full bg-gradient-to-br from-greenlock-500/20 to-greenlock-400/5 relative z-10">
        <Icon className="w-8 h-8 md:w-10 md:h-10 text-greenlock-400" />
      </div>
      {/* Anillos pulsantes */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-greenlock-500/10 animate-pulse-ring1"></div>
        <div className="absolute w-18 h-18 md:w-20 md:h-20 rounded-full bg-greenlock-500/5 animate-pulse-ring2"></div>
      </div>
    </div>
  );
}
...
export default function HeroSection() {
  ...
  return (
    <section 
      id="hero" 
      className="relative w-full min-h-screen flex items-center overflow-hidden py-16 sm:py-20 md:py-24 lg:py-0 lg:min-h-screen"
      ...
      <div className="container relative z-20 mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 lg:mb-6 tracking-tight leading-tight">
            ...
            <div className={`mb-4 lg:mb-6 transition-opacity duration-700 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
              <RotatingTypewriter />
            </div>
            
            <p className={`text-sm sm:text-base text-gray-400 mb-6 lg:mb-8 max-w-2xl mx-auto lg:mx-0 transition-opacity duration-700 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <a 
                href="#contacto" 
                className="px-4 sm:px-6 py-3 bg-gradient-to-r from-greenlock-600 to-greenlock-400 text-white rounded-md font-medium transition-all duration-300 shadow-lg hover:shadow-greenlock-500/50 hover:-translate-y-1 relative overflow-hidden group animate-button-pulse border border-greenlock-400/30 text-sm sm:text-base"
              >
              ...
              <a 
                href="#servicios" 
                className="px-4 sm:px-6 py-3 border border-greenlock-500/40 text-greenlock-400 rounded-md font-medium hover:border-greenlock-400 hover:bg-greenlock-500/10 transition-all duration-300 flex items-center gap-2 group hover:-translate-y-1 justify-center text-sm sm:text-base"
              >
                Explorar servicios
          ...
          {/* Terminal de código rectangular - Oculto en móviles pequeños */}
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mt-12 lg:mt-16 transition-all duration-1000 ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="feature-card bg-gradient-to-br from-[#0a1426]/90 to-[#0a1426]/70 backdrop-blur-sm border border-gray-800 rounded-lg p-4 lg:p-6 hover:border-greenlock-500/30 transition-all hover:shadow-xl hover:shadow-greenlock-900/10 group">
            <PulsingIcon icon={Shield} />
            <h3 className="text-lg lg:text-xl font-semibold text-center text-white mb-2">Experiencia Certificada</h3>
          ...
          <div className="feature-card bg-gradient-to-br from-[#0a1426]/90 to-[#0a1426]/70 backdrop-blur-sm border border-gray-800 rounded-lg p-4 lg:p-6 hover:border-greenlock-500/30 transition-all hover:shadow-xl hover:shadow-greenlock-900/10 group" style={{ transitionDelay: '200ms' }}>
            <PulsingIcon icon={Scale} />
            <h3 className="text-lg lg:text-xl font-semibold text-center text-white mb-2">Estándares Globales</h3>
            <p className="text-gray-400 text-xs lg:text-sm text-center">
              Metodologías alineadas con MITRE ATT&CK, OWASP Top 10 y normativas NIS
            </p>
          </div>
          
          <div className="feature-card bg-gradient-to-br from-[#0a1426]/90 to-[#0a1426]/70 backdrop-blur-sm border border-gray-800 rounded-lg p-4 lg:p-6 hover:border-greenlock-500/30 transition-all hover:shadow-xl hover:shadow-greenlock-900/10 group" style={{ transitionDelay: '400ms' }}>
            <PulsingIcon icon={Monitor} />
            <h3 className="text-lg lg:text-xl font-semibold text-center text-white mb-2">Cobertura Integral</h3>
            <p className="text-gray-400 text-xs lg:text-sm text-center">
