...
const TechBackground = () => {
  ...
  return (
    <canvas 
      ref={canvasRef} 
      className="contact-hero-tech-background"
      style={{ background: '#080f1d' }}
    />
  );
};

const ContactHero = ({ isLoaded = true }: ContactHeroProps) => {
  return (
      ...
      <div className="contact-hero-content">
        <div className="contact-hero-title-container">
          <h1 className="contact-hero-main-title">
            ...
            >
              Contáctanos <span className="contact-hero-title-gradient">Ahora</span>
            </span>
          </h1>
        </div>
        ...
        >
          ...
          <span className="contact-hero-highlight">te contactará en menos de 24 horas</span> para diseñar{' '}
          <span className="contact-hero-highlight">una estrategia de seguridad personalizada</span>.
        </p>
      </div>
    </section>
  );
